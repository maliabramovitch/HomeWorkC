...
Set SetCreate(Element (*clone_func)(Element), void (*free_func)(Element), bool (*cmp_func)(Element, Element)) {
...
static Element *FirstElementAfter(Element *it, Element *it_end) {
